                        ...
                        <div class="row">                            
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="s">Kode / Nama Barang Masuk</label>
                    ...
                    <div class="table-responsive mt-3">
                        ...
                        <table id="add-row" class="table table-striped table-borderless table-hover " >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td class="text-nowrap"><?= date_format(date_create($d->tanggal_masuk), 'd/m/Y'); ?></td>
                                    <td class="text-nowrap"><?= $d->kode_barang ?></td>
                                    <td><?= $d->barang ?></td>
                                    <td><?= $d->jenis ?></td>
                                    <td><?= $d->lokasi ?></td>
                                    <td><?= number_format($d->jumlah_masuk,0,',','.');  ?> (<?= $d->satuan ?>)</td>
                                    <td>
                                        <div class="form-button-action" style="margin-left: -20px;">
                                            <div class="form-button-action">
                                                <a href="<?= base_url();?>barangmasuk/edit/<?= $d->idbarang_masuk; ?>" data-toggle="tooltip" data-original-title="Edit"> 
                                                    <i class="fa fa-pencil-alt text-inverse mr-2"></i>
                                                </a>
                                                <a href="<?= base_url();?>barangmasuk/delete/<?= $d->idbarang_masuk; ?>" data-toggle="tooltip" data-original-title="Hapus" class="btn-delete">
