...
<div class="section-body">
    ...
    <p class="section-lead">Halaman untuk melihat data peminjaman barang </p>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row">                            
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" data-name="s" name="s" placeholder="Tulis Kode Peminjaman / Peminjam" value="<?= $s?>" >
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="lingkungan">Barang</label>
                                    <select class="form-control select2" id="input-barang" >
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="status" name="status" >
                                        ...
                                        <option value="1" <?= ($status == '0')?'selected':''; ?> >Belum Dikembalikan</option>
                                        <option value="0" <?= ($status == '1')?'selected':''; ?> >Telah Dikembalikan</option>
                                    </select>
                                </div>
                            </div>         
                            <div class="col-xl-4 col-md-6 col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center">
                        ...
                        <a href="<?= base_url()?>barangmasuk/tambah/" class="ml-auto"><button class="btn btn-primary btn-round ml-auto">
                        ...
                        <table id="add-row" class="table table-striped table-borderless table-hover " >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap"><?= '['.$d->kode_barang.']'.$d->barang ?></td>
