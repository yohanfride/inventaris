...
<div class="section-body">
    ...
    <p class="section-lead">Halaman untuk tambah data jenis barang</p>
    <div class="row">
        <div class="col-md-8">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0">Form Tambah Data Jenis Barang </h4>
                </div>
                <div class="card-body">
                    <form method="post" class="form-material" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Masukkan Jenis Barang" required="required" >
                            </div>    
                            <div class="form-group">
