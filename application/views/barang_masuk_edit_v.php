...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?= base_url()?>barangmasuk<?= (!empty($params))?'/?'.$params:''; ?>">Data Barang Masuk</a></div>
      <div class="breadcrumb-item">Ubah</div>
    </div>
</div>

<div class="section-body">
    <h2 class="section-title">Ubah Data Barang Masuk</h2>
    <p class="section-lead">Halaman untuk ubah data barang masuk</p>
    <div class="row">
        <div class="col-md-8">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0">Form Ubah Data Barang Masuk </h4>
                </div>
                <div class="card-body">
                    <form method="post" class="form-material" enctype="multipart/form-data" >
                        ...
                        <div class="form-body "> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Masukkan Jumlah Barang Masuk" required="required" value="<?= $data->jumlah_masuk ?>">
                            </div> 
                            <div class="form-group">
                                <label for="nama" >Tanggal Input</label>
                                <input type="text" class="form-control datepicker" id="tanggal" name="tanggal" placeholder="Masukkan Tanggal Input" required="required" value="<?= $data->tanggal_masuk?>">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="hidden" name="jumlah_old" value="<?= $data->jumlah_masuk; ?>"> 
                        </div>
