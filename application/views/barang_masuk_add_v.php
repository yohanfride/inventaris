...
<div class="section-body">
    <h2 class="section-title">Tambah Data Barang Masuk</h2>
    <p class="section-lead">Halaman untuk tambah data barang masuk</p>
    <div class="row">
        <div class="col-md-8">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0">Form Tambah Data Barang Masuk </h4>
                </div>
                <div class="card-body">
                    <form method="post" class="form-material" enctype="multipart/form-data" >
                        ...
                        <div class="form-body "> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Masukkan Jumlah Barang Masuk" required="required">
                            </div> 
                            <div class="form-group">
